...
create_link("browse-at-remote.el", 50)
...
create_link("slim-mode.el", 60)
create_link("smart-jump.el", 52)
create_link("typescript.el", 60)
# create_link("view.el", 60)
create_link("vue-mode.el", 60)
create_link("which-key.el", 55)
create_link("yaml-mode.el", 60)
